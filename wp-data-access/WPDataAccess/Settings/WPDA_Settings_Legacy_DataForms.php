        ...
        <form id="wpda_settings_forms" method="post"
            ...
            <table class="wpda-table-settings">
                <tr style="border-top: 1px solid #ccc">
                    <th><?php esc_html_e( 'Allow anonymous access', 'wp-data-access' ); ?></th>
                    <td>
                        <label>
                ...
                <tr>
                    <th><?php esc_html_e( 'Default jQuery UI theme', 'wp-data-access' ); ?></th>
                    <td>
                        <a href="<?php echo esc_url( admin_url( 'options-general.php' ) ); ?>?page=wpdataaccess&tab=frontend">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php esc_html_e( 'Data Forms are styled according to the default jQuery UI theme', 'wp-data-access' ); ?>
                        <br/>
                        <span class="dashicons dashicons-yes"></span>
                        <?php esc_html_e( 'Individual styling per shortcode will be added later', 'wp-data-access' ); ?>
                    </td>
                </tr>
            </table>
            <div class="wpda-table-settings-button">
                ...
                <button type="submit" class="button button-primary">
                    ...
                    <?php esc_html_e( 'Save Data Forms  Settings', 'wp-data-access' ); ?>
                </button>
                <a href="javascript:void(0)"
                   ...
                   class="button">
                    ...
                    <?php esc_html_e( 'Reset Data Forms Settings To Defaults', 'wp-data-access' ); ?>
                </a>
            </div>
